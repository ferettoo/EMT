    ...
    <div class="row">
      ...
      <div class="col-8 p-1">
        ...
        <div class="card border border-0 mb-3">
          <div
            class="card-header border-0 border-success text-center"
            style="background-color: #0f9db2"
          >
          ...
          >
            <div class="row">
              <div class="col-4">
                ...
                <div class="row">
                  <label for="save" class="col-9 text-secondary"
                  ...
                  <div class="col-3">
                    <input
                      ...
                      name="save"
                      id="save"
                      v-model="carta.guardarInterlocutor"
                    />
                  </div>
                </div>
                <div class="mb-2">
                ...
                <div class="mb-2">
                  ...
                  <input
                    ...
                    class="form-control w-100"
                    id="apellido"
                    v-model="carta.apellido"
                  />
                </div>
                <div class="custom-height">
                  <label for="antecedentes" class="form-label"
                    >Antecedentes del Telefóno</label
                  >
                  <textarea
                    class="form-control h-100"
                    id="antecedentes"
                    v-model="carta.antecedentesInterlocutor"
                  ></textarea>
                </div>
              </div>
              <div class="col-8">
                ...
                <div class="mb-2">
                  <p class="fs-6 mb-2">
                    ...
                    >
                      <img
                        class="helpbox_boton"
                        src="../../../../public/images/helpbox_boton.png"
                        height="18px"
                        width="18px"
                        alt="helpbox"
                      />
                  ...
                  >
                    ...
                    <option
                      v-for="tipoIncidente in tipoIncidentes"
                  ...
                  <textarea
                    ...
                    id="antecedentes"
                    rows="3"
                    placeholder="Explicación del incidente.."
                    v-model="definicioIncidente"
                    disabled
                  ></textarea>
                </div>
                <p class="fs-6 mb-1">
                ...
                <div class="row">
                  <div class="col">
                    <div class="row mt-2">
                      <label for="cataluna" class="col-9 text-secondary"
                        >Esta en cataluña?</label
                      >
                      <div class="col-3">
                        <input
                          type="checkbox"
                    ...
                    <div v-if="estaEnCataluna">
                      <div class="mb-2" style="margin-top: 18px">
                        <div class="mb-2">
                          <label for="provincia" class="form-label"
                            >Provincia
                            <span style="color: #e0127a">*</span></label
                          >
                          <select
                            class="form-select w-100 mb-2"
                            v-model="carta.idProvincia"
                        ...
                        <label for="comarca" class="form-label"
                          >Comarca <span style="color: #e0127a">*</span></label
                        >
                        <select
                          class="form-select w-100 mb-2"
                          v-model="comarca_id"
                        ...
                        >
                          ...
                          <option
                            v-for="comarca in comarcasFiltradas"
                            :key="comarca.id"
                            :value="comarca.id"
                          >
                            {{ comarca.nom }}
                      ...
                      <div class="mb-2">
                        ...
                        <select
                          class="form-select w-100 mb-2"
                          v-model="carta.idMunicipio"
                        >
                          <option disabled value="">
                            Seleccione un Municipio
                          </option>
                          <option
                            v-for="municipio in municipioFiltrados"
                            :key="municipio.id"
                            :value="municipio.id"
                          >
                            {{ municipio.nom }}
                      ...
                      <div class="mb-2">
                        <textarea
                          ...
                          v-model="carta.otrasRefLocalizacion"
                        ></textarea>
                      </div>
                    </div>
                  ...
                  <div class="col">
                    <select
                      class="form-select w-100 mb-2"
                      v-model="carta.tipoLocalizacion"
                    >
                      <option disabled>Tipo de localización..</option>
                      <option v-if="!estaEnCataluna" :value="'5'" selected>
                        Provincia
                      </option>
                    ...
                    <div v-if="carta.tipoLocalizacion == 1">
                      <div class="mb-2">
                        ...
                        <input
                          ...
                          class="form-control w-100"
                          id="nomCarretera"
                          v-model="descripcionLocalizacion.nomCarretera"
                        />
                      </div>
                      <div class="mb-2">
                        <label for="puntoKilometrico" class="form-label"
                          >Punto Kilometrico</label
                        >
                        <input
                          type="text"
                          class="form-control w-100"
                          id="puntoKilometrico"
                          v-model="descripcionLocalizacion.puntoKilometrico"
                        />
                      </div>
                      <div class="mb-2">
                        ...
                        <input
                          ...
                          class="form-control w-100"
                          id="sentido"
                          v-model="descripcionLocalizacion.sentido"
                        />
                      </div>
                      <div class="mb-2">
                        <textarea
                          ...
                          rows="1"
                          placeholder="Explicación breve.."
                          v-model="carta.detallesLocalizacion"
                        ></textarea>
                      </div>
                    </div>
                    <div v-else-if="carta.tipoLocalizacion == 2">
                      <div class="mb-2">
                        ...
                        <input
                          type="text"
                          class="form-control w-100"
                          id="nombrePuntoSingular"
                          v-model="descripcionLocalizacion.nombrePuntoSingular"
                        />
                      </div>
                      <div class="mb-2">
                        <label for="puntoSingular" class="form-label"
                          >Punto Singular</label
                        >
                        <input
                          type="text"
                          class="form-control w-100"
                          id="puntoSingular"
                          v-model="descripcionLocalizacion.puntoSigular"
                        />
                      </div>
                      <div class="mb-2">
                        <textarea
                    ...
                    <div v-else-if="carta.tipoLocalizacion == 3">
                      <div class="mb-2">
                        ...
                        <input
                          ...
                          class="form-control w-100"
                          id="tipoVia"
                          v-model="descripcionLocalizacion.tipoVia"
                        />
                      </div>
                      <div class="mb-2">
                        <label for="nombreCalle" class="form-label"
                          >Nombre</label
                        >
                        <input
                          type="text"
                          class="form-control w-100"
                          id="nombreCalle"
                          v-model="descripcionLocalizacion.nombre"
                        />
                      </div>
                      <div
                        class="mb-2 d-flex justify-content-evenly text-center"
                      >
                      ...
                      <div class="mb-2 d-flex justify-content-between">
                        <input
                          ...
                          v-model="descripcionLocalizacion.numero"
                        />
                        <input
                          type="number"
                          class="form-control mx-1"
                          v-model="descripcionLocalizacion.escalera"
                        />
                        <input
                          type="number"
                          class="form-control mx-1"
                          v-model="descripcionLocalizacion.puerta"
                        />
                        <input
                          type="number"
                          class="form-control mx-1"
                          v-model="descripcionLocalizacion.piso"
                        />
                      </div>
                      <div class="mb-2">
                        <textarea
          ...
          <div class="mt-4 d-flex justify-content-center">
            <button class="w-50 btn btn-warning" @click="finalizarLlamada">
              <strong>Finalizar Carta de Llamada</strong>
            </button>
          </div>
        </div>
      </div>
      ...
      <div class="col-4 d-flex flex-column p-1">
        <div class="h-50 tableContainer" style="background-color: #f9f9f9">
          ...
          <table class="table table-borderless">
            <thead
              class="text-center text-light w-bold"
              style="background-color: #0f9db2"
            >
              <tr>
            ...
            <tbody class="text-center" style="background-color: #f9f9f9">
              <tr v-for="expediente in expedienteFiltrado" :key="expediente.id">
                <th scope="col" class="align-middle">
                  {{ expediente.expedients.codi }}
                </th>
                <!-- <td scope="col">{{ expediente.estat_expedients_id }}</td> -->
                <td
                  v-if="expediente.expedients.estat_expedients_id == 1"
                  class="d-grid"
                >
                  <button
                    type="button"
                    class="btn btn-sm disabled rounded-2 text-white"
                    style="background-color: #39df09"
                    @click="asociarExpediente(expediente)"
                  >
                    EnProcés
                  </button>
                </td>
                <td
                  v-else-if="expediente.expedients.estat_expedients_id == 2"
                  class="d-grid"
                >
                  <button
                    type="button"
                    class="btn btn-sm btn-warning disabled rounded-2 text-white"
                  >
                    Sol·licitat
                  </button>
                </td>
                <td
                  v-else-if="expediente.expedients.estat_expedients_id == 3"
                  class="d-grid"
                >
                  <button
                    type="button"
                    class="btn btn-sm btn-success disabled rounded-2 text-white"
                  >
                    Acceptat
                  </button>
                </td>
                <td
                  v-else-if="expediente.expedients.estat_expedients_id == 4"
                  class="d-grid"
                >
                  <button
                    type="button"
                    class="btn btn-sm disabled rounded-2 text-white"
                    style="background-color: #2587e8"
                  >
                    Tancat
                  </button>
                </td>
                <td
                  v-else-if="expediente.expedients.estat_expedients_id == 5"
                  class="d-grid"
                >
                  <button
                    type="button"
                    class="btn btn-sm btn-info disabled rounded-2 text-white"
                  >
                    Immobil
                  </button>
                </td>
                ...
                <td scope="col" class="align-middle" style="font-size: 13px">
                  12/10/2023
                </td>
        ...
        <div class="h-50 position-relative">
          ...
          >
            <a :href="direccionUrl" target="_blank"
              ><strong
                ><i class="bi bi-geo-alt-fill"></i> LOCALIZACIÓN</strong
              ></a
            >
          </button>
        </div>
...
export default {
  ...
  methods: {
    ...
    incidentesVisibles() {
      ...
      this.incidentesFiltrados = this.incidentes.filter(
        (opcion) => opcion.tipus_incidents_id == this.tipoIncidente_id
      );
    ...
    mostrarDefinicion() {
      const opcionSeleccionada = this.incidentesFiltrados.find(
        (opcion) => opcion.id === this.carta.incidente
      );
      const dIncidente = opcionSeleccionada ? opcionSeleccionada.definicio : "";
      this.definicioIncidente = dIncidente;
    },
    comarcasVisibles() {
      this.comarcasFiltradas = this.comarcas.filter(
        (opcion) => opcion.provincies_id == this.carta.idProvincia
      );
    },
    mucipiosVisibles() {
      this.municipioFiltrados = this.municipios.filter(
        (opcion) => opcion.comarques_id == this.comarca_id
      );
    },
    contador() {
    ...
    concatenarDetallesLocalizacion() {
      this.carta.descripcionLocalizacion = Object.values(
    ...
    asociarExpediente(expediente) {
      ...
      if (expediente.interlocutors != null) {
        ...
        this.carta.antecedentesInterlocutor =
          expediente.interlocutors.antecedents;
      } else {
        this.carta.nombre = "";
        this.carta.apellido = "";
        this.carta.antecedentesInterlocutor = "";
  ...
  watch: {
    ...
    "carta.telefono": {
      handler() {
        this.expedienteFiltrado = this.cartasDeLlamada.filter(
          (carta) => carta.telefon === this.carta.telefono
        );
      },
    },
    "carta.idProvincia": {
      handler() {
        this.expedienteFiltrado = this.cartasDeLlamada.filter(
          (carta) => carta.provincies_id === this.carta.idProvincia
        );
    ...
    "carta.incidente": {
      handler() {
        this.expedienteFiltrado = this.cartasDeLlamada.filter(
          (carta) => carta.incidents_id === this.carta.incidente
        );
        console.log(this.expedienteFiltrado);
      },
    },
