                ...
                <div class="container ">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav text-center mx-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="#"> EXPEDIENTES</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="#">GRAFICOS</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="#">HELPBOX</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <a>
                            <button class="rounded-5 btn btn-warning" style="color: #000000; font-weight: 700;"
                                type="submit">
                        ...
                        <div class="nav-item dropdown d-flex">
                            <ul class="nav justify-content-end">
                                <a style="color: #000000;" class="nav-link dropdown-toggle" href="#"
